...
public class HongoLogManager {
  ...
  static void d(String tag, String msg) {
    for (Logger logger : loggers) {
      if (logger.active()) {
        Log.d(StrUtil.concat(logger.getTag(), HONGO, tag), msg);
      }
    }
  }
  ...
  static void e(String tag, String msg) {
    for (Logger logger : loggers) {
      if (logger.active()) {
        Log.e(StrUtil.concat(logger.getTag(), HONGO, tag), msg);
      }
    }
  }
  ...
  static void e(String tag, String msg, Throwable t) {
    for (Logger logger : loggers) {
      if (logger.active()) {
        Log.e(StrUtil.concat(logger.getTag(), HONGO, tag), msg, t);
      }
    }
  }
}
