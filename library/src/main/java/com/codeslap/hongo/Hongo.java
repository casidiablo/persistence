 ...
 */
public class Hongo {
  private static final String TAG = Hongo.class.getSimpleName();
  public static final String DEFAULT_DATABASE_NAME = "com.codeslap.hongo.db";
   ...
   *         ({@link #DEFAULT_DATABASE_NAME}) and specification ({@link HongoConfig#DEFAULT_SPEC_ID})
   */
  public static SqlAdapter getAdapter(Context context) {
    return getAdapter(context, DEFAULT_DATABASE_NAME, HongoConfig.DEFAULT_SPEC_ID);
  }
   ...
   *         ({@link HongoConfig#DEFAULT_SPEC_ID})
   */
  public static SqlAdapter getAdapter(Context context, String dbName) {
    return getAdapter(context, dbName, HongoConfig.DEFAULT_SPEC_ID);
  }
  ...
  public static SqlAdapter getAdapter(Context context, String dbName, String specId) {
    HongoLogManager.d(TAG,
        StrUtil.concat("Getting database adapter for ", dbName, " database with ", specId, " spec"));
  ...
  public static RawQuery getRawQuery(Context context) {
    return new RawQueryImpl(context, DEFAULT_DATABASE_NAME, HongoConfig.DEFAULT_SPEC_ID);
  }
  ...
  public static RawQuery getRawQuery(Context context, String name) {
    return new RawQueryImpl(context, name, HongoConfig.DEFAULT_SPEC_ID);
  }
