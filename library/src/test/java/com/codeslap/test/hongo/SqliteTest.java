...
public abstract class SqliteTest {
  ...
  @Before public void configure() {
    ...
    mAdapter = Hongo.getAdapter(new Activity());
  ...
  public static class AnnotationAutoincrement {
    @PrimaryKey long something;
    @Column(value = "char_sequence", notNull = true) String name;
    @Column(value = "middle_name") String middleName;
    @Column(value = "the_last_name", notNull = true, defaultValue = "Castiblanco") String lastName;
    @Column("signed") int number;
    @Column("value") float decimal;
  ...
  public static class AnnotationNotAutoincrement {
    @PrimaryKey(autoincrement = false) long something;
    @Column(value = "char_sequence", notNull = true) String name;
    @Column(value = "the_last_name", notNull = true, defaultValue = "Castiblanco") String lastName;
    @Column("signed") int number;
    @Column("value") float decimal;
