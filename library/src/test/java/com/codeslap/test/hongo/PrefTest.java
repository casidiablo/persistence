...
public abstract class PrefTest {
  ...
  public void configure() {
    HongoPrefs preference = HongoConfig.getPreference();
    preference.match(PreferenceBean.class, PrefImpossibleBean.class, PrefWithAnnotations.class);
    preference = HongoConfig.getPreference("test.pref");
    preference.match(PreferenceBean.class, PrefImpossibleBean.class, PrefWithAnnotations.class);
  }
  ...
  public static class PrefWithAnnotations {
    @Preference(value = "the_long", defaultValue = Long.MIN_VALUE + "") long veryLong;
    @Preference(value = "the_string", defaultValue = "foo bar") String name;
    @Preference(value = "the_integer", defaultValue = Integer.MIN_VALUE + "") int number;
    @Preference(value = "the_decimal", defaultValue = Float.MIN_VALUE + "") double decimal;
    @Preference(value = "the_boolean", defaultValue = "true") boolean bool;
